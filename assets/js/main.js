...
jQuery(function ($) {
	...
	$(window).scroll(function () {
		...
		var widget = $('.nyang-body .side-widget');
...
jQuery(function ($) {
	...
	// Slider
	$('.nyang-section .slider').each(function () {
	...
	// Thumbnail Slider
	const ThumbnailSliderControl = new Swiper('.nyang-section .thumbnail-slider .thumbnail-slider-control', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		breakpoints: {
	...
	const ThumbnailSlider = new Swiper('.nyang-section .thumbnail-slider .thumbnail-slider-items', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
jQuery(function ($) {
	...
	var section = $('.nyang-section .shuffle');
...
jQuery(function ($) {
	$('.nyang-section .gallery').lightGallery({
		selector: '.nyang-section .gallery .lightbox-link:not(.prevent)',
		thumbnail: false,
		share: false,
		download: false
	})
